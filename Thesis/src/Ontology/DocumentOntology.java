...
public class DocumentOntology extends Ontology {
	...
	public static final String OWNERCONTAINER = "OWNERCONTAINER";
	...
	private DocumentOntology() {
		...
		try {
			...
			documentSchema.add(OWNER, stringSchema, ObjectSchema.OPTIONAL);
			documentSchema.add(OWNERCONTAINER, stringSchema, ObjectSchema.OPTIONAL);
